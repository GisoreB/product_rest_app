...
Future<List<Product>> fetchProducts() async {
  var url = Uri.parse('http://192.168.10.0:8000/products.json');
  final response =
      await http.get(url);
          ...
          child: FutureBuilder<List<Product>>(
            ...
            builder: (context, snapshot) {
              ...
              return snapshot.hasData
                  ? ProductBoxList(items: (snapshot.data) as List<Product>)
                  :
